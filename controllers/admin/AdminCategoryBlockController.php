...
use mdg\homecategorypush\Forms\CategoryBlockForm;
use mdg\homecategorypush\Models\CategoryBlockModel;

require_once __DIR__ . '../../../vendor/autoload.php';

class AdminCategoryBlockController extends ModuleAdminController
{
    /** @var boolean */
    public $lang = true;
    ...
    {
        $this->table = CategoryBlockModel::$definition['table'];
        $this->identifier = CategoryBlockModel::$definition['primary'];
        $this->className = CategoryBlockModel::class;
    ...
    {
        foreach ((new CategoryBlockForm($this->object))->modifyControllerFormHelper() as $key => $value) {
            $this->$key = $value;
        }
    ...
    {
        foreach ($this->className::IMAGES_NAMES as $imageName => $imageParams) {
